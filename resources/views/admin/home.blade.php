...
<div class="row justify-content-center">
  <div class="col-sm-8">
      ...
      <li class="list-group-item"><div class="row"><a href="#" class="col-sm-11 list-group-item-action h-100" data-toggle="collapse" data-target="#admins"><span class="fa fa-angle-double-down"></span> Admins</a><a class="col" href="{{ route('admin.cadastrar',['entidade' => 'usuario']) }}"><span class="fa fa-plus text-success " style="font-size:20px;"></span></a></div></li>
        ...
        @endif
        <li class="list-group-item"><div class="row"><a href="#" class="col-sm-11 list-group-item-action h-100" data-toggle="collapse" data-target="#usuarios"><span class="fa fa-angle-double-down"></span> Usuarios</a><a class="col" href="{{ route('admin.cadastrar',['entidade' => 'usuario']) }}"><span class="fa fa-plus text-success " style="font-size:20px;"></span></a></div></li>
        ...
        @endif
        <li class="list-group-item"><div class="row"><a href="#" class="col-sm-11 list-group-item-action h-100" data-toggle="collapse" data-target="#produtos"><span class="fa fa-angle-double-down"></span> Produtos</a><a class="col" href="{{ route('admin.cadastrar',['entidade' => 'produto']) }}"><span class="fa fa-plus text-success " style="font-size:20px;"></span></a></div></li>
          ...
          @endif
          <li class="list-group-item"><div class="row"><a href="#" class="col-sm-11 list-group-item-action h-100" data-toggle="collapse" data-target="#categorias"><span class="fa fa-angle-double-down"></span> Categorias</a><a class="col" href="{{ route('admin.cadastrar',['entidade' => 'categoria']) }}"><span class="fa fa-plus text-success " style="font-size:20px;"></span></a></div></li>
